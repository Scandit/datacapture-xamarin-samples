...
{
    public class ViewfinderSpotlightWidthMeasureFragment : MeasureUnitFragment
    {
        ...
        public override void OnCreate(Bundle savedInstanceState)
        {
            ...
            this.viewModel = ViewModelProviders.Of(this)
                                               .Get(Java.Lang.Class.FromType(typeof(ViewfinderSpotlightWidthViewModel))) as ViewfinderSpotlightWidthViewModel;
        }
