...
namespace BarcodeCaptureSettingsSample.DataSource.Settings.View.Viewfinder
{
    public class SpotlightViewfinderBackgroundColor : Enumeration
    {
        ...
        public static readonly SpotlightViewfinderBackgroundColor Blue = new SpotlightViewfinderBackgroundColor(1, "Blue", UIColor.Blue);
        public static readonly SpotlightViewfinderBackgroundColor Black = new SpotlightViewfinderBackgroundColor(2, "Green", UIColor.Green);
