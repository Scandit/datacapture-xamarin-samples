...
{
    public class ViewfinderRectangleHeightMeasureFragment : MeasureUnitFragment
    {
        private ViewfinderRectangleHeightViewModel viewModel;

        public static ViewfinderRectangleHeightMeasureFragment Create()
        {
        ...
        public override void OnCreate(Bundle savedInstanceState)
        {
            ...
            this.viewModel = ViewModelProviders.Of(this)
                                               .Get(Java.Lang.Class.FromType(typeof(ViewfinderRectangleHeightViewModel))) as ViewfinderRectangleHeightViewModel;
        }
