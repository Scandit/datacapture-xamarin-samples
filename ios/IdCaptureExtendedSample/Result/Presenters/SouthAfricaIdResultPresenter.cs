    ...
    public class SouthAfricaIdResultPresenter : IResultPresenter
    {
        ...
        private IList<ICellProvider> GetSouthAfricaIdBarcodeRows(SouthAfricaIdBarcodeResult southAfricaIdBarcodeResult)
        {
            var southAfricaIdBarcodeRows = new[] {
                new SimpleTextCellProvider(value: southAfricaIdBarcodeResult.CountryOfBirthIso, title: "Country of Birth ISO"),
                new SimpleTextCellProvider(value: southAfricaIdBarcodeResult.CountryOfBirth, title: "Country of Birth"),
                new SimpleTextCellProvider(value: southAfricaIdBarcodeResult.CitizenshipStatus, title: "Citizenship Status"),
                new SimpleTextCellProvider(value: southAfricaIdBarcodeResult.PersonalIdNumber, title: "Personal ID Number")
            };
