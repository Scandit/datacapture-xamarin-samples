...
{
    public class ScanAreaLeftMarginFragment : MeasureUnitFragment
    {
        private ScanAreaLeftMarginViewModel viewModel;
        public static ScanAreaLeftMarginFragment Create()
        {
        ...
        public override void OnCreate(Bundle savedInstanceState)
        {
            ...
            this.viewModel = ViewModelProviders.Of(this)
                                               .Get(Java.Lang.Class.FromType(typeof(ScanAreaLeftMarginViewModel))) as ScanAreaLeftMarginViewModel;
        }

        public override FloatWithUnit CurrentFloatWithUnit => this.viewModel.Margin;

        protected override string GetTitle() => this.Context.GetString(Resource.String.left);
