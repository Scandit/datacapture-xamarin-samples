    ...
    public class UsUniformedServicesResultPresenter : IResultPresenter
    {
        ...
        private IList<ICellProvider> GetUsUniformedServicesBarcodeRows(UsUniformedServicesBarcodeResult usUniformedServicesResult)
        {
            var usUniformedServicesBarcodeRows = new[] {
                ...
                new SimpleTextCellProvider(value: usUniformedServicesResult.ChampusEffectiveDate?.LocalDate.ToString(), title: "Champus Effective Date"),
                new SimpleTextCellProvider(value: usUniformedServicesResult.ChampusExpiryDate?.LocalDate.ToString(), title: "Champus Expiry Date"),
